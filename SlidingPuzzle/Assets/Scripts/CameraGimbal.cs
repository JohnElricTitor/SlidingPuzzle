...
//THIS SCRIPT CENTERS TEH CAMERA GIMBAL OBJECT SO THAT THE CAMERA ALWAYS ROTATES AROUND THE CENTER OF THE LEVEL
public class CameraGimbal : MonoBehaviour
{
    ...
    void Start()
    {
        if (tower != null && tower.GetChild(0).GetComponent<LevelGenerator>() != null)      //USES IF STATEMENT PREVENT ERROR FROM MISSING PREFABS
        {
